...
//unsigned long long int software_hardware_count[NUM_KERNELS + 1];
//long long int kernel_duration[NUM_KERNELS];
//long long int kernel_process_duration[NUM_KERNELS];
//long long int kernel_write_transfer_duration[NUM_KERNELS];
//long long int kernel_read_transfer_duration[NUM_KERNELS];
//long long int time_in_line;
int num_reads;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/*int teng;
	fprintf(stderr, "software_hardware_count\n");
	for (teng = 0; teng < NUM_KERNELS + 1; teng++) {
		fprintf(stderr, "%lld ", software_hardware_count[teng]);
	}
	fprintf(stderr, "\n\n");
	fprintf(stderr, "kernel_duration\n");
	for (teng = 0; teng < NUM_KERNELS; teng++) {
		fprintf(stderr, "%lld ", kernel_duration[teng]);
	}
	fprintf(stderr, "\n\n");
	fprintf(stderr, "kernel_process_duration\n");
	for (teng = 0; teng < NUM_KERNELS; teng++) {
		fprintf(stderr, "%lld ", kernel_process_duration[teng]);
	}
	fprintf(stderr, "\n\n");
	fprintf(stderr, "kernel_write_transfer_duration\n");
	for (teng = 0; teng < NUM_KERNELS; teng++) {
		fprintf(stderr, "%lld ", kernel_write_transfer_duration[teng]);
	}
	fprintf(stderr, "\n\n");
	fprintf(stderr, "kernel_read_transfer_duration\n");
	for (teng = 0; teng < NUM_KERNELS; teng++) {
		fprintf(stderr, "%lld ", kernel_read_transfer_duration[teng]);
	}
	fprintf(stderr, "\n\n");
	fprintf(stderr, "time_in_line\n");
	fprintf(stderr, "%lld\n\n", time_in_line);*/
	
	fpga_shutdown_and_cleanup();
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
